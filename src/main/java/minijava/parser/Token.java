/* Generated By:JavaCC: Do not edit this line. bioscript.parser.Token.java Version 6.0 */
...
public class Token implements java.io.Serializable {
    ...
    /**
     * The line number of the first character of this bioscript.parser.Token.
     */
    public int beginLine;
    /**
     * The column number of the first character of this bioscript.parser.Token.
     */
    public int beginColumn;
    /**
     * The line number of the last character of this bioscript.parser.Token.
     */
    public int endLine;
    /**
     * The column number of the last character of this bioscript.parser.Token.
     */
    ...
    /**
     * An optional attribute value of the bioscript.parser.Token. Tokens which are not used as
     * syntactic sugar will often contain meaningful values that will be used later on by the
     * compiler or interpreter. This attribute value is often different from the image. Any subclass
     * of bioscript.parser.Token that actually wants to return a non-null value can override this
    ...
    /**
     * Returns a new bioscript.parser.Token object, by default. However, if you want, you can create
     * and return subclass objects based on the value of ofKind. Simply add the cases to the switch
     * for all those special cases. For example, if you have a subclass of bioscript.parser.Token
